...
def round_robin(processes, time_quantum):
    ...
    while queue:
        ...
        if process['burst_time'] > 0:
            queue.append(process)  # Re-append process to queue if it's not completed
        else:
...
def shortest_job_first(processes):
    ...
    while len(completed_processes) < n:
        ...
        # Remove it from the main list and mark as completed
        ...
        # Update completed time and add to Gantt chart
